...
% 
% R = diag([1 1 0.01]); %process noise covariance matrix
% Q = diag([1;0.4]); % measurement noise covariance matrix

R = diag([0.5 0.5 0.01]); %process noise covariance matrix
Q = diag([1;0.3]); % measurement noise covariance matrix
Lambda_psi = 0.0001;
