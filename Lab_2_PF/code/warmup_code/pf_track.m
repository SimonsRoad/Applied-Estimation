...
params.state_space_dimension = 3; % either 3 or 2
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
params.Sigma_Q = diag([400 400]); % measurement noise covariance matrix
% params.Sigma_Q = diag([0.0001 0.0001]); % measurement noise covariance matrix
% params.Sigma_Q = diag([10000 10000]); 
...
%         params.Sigma_R = diag([0 0]); % process noise covariance matrix
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         params.Sigma_R = diag([40 40 0.01]);
